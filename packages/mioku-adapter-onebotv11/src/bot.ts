...
export type OneBot = MiokuBot & {
  ...
  getHistory(target: MessageTarget, before?: string, limit?: number, extra?: Record<string, unknown>): Promise<HistoryMessage[]>
...
export const createOneBot = (params: {
  ...
  const bot: OneBotBase = {
    ...
    async getHistory(target: MessageTarget, before?: string, limit = 20, extra: Record<string, unknown> = {}) {
      let raw: unknown
